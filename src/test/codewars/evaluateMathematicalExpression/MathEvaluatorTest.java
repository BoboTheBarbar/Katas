...
class MathEvaluatorTest {
	  ...
	  @Test void testAdditionComplex() {
		    assertEquals(new MathEvaluator().calculate("1+1--2-4"), 0d, 0.01);
	  }
	  
	  @Test void testAdditionLongNumbers() {
