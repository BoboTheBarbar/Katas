...
class FractsTest {
    ...
    @Test
    public void check_fractions_empty() {
        long[][] lst;
        lst = new long[][]{};
    ...
    @Test
    public void check_fractions_OutOfBounds() {
        long[][] lst;
    ...
    @Test
    public void check_fractions_OutOfBounds2() {
        long[][] lst;
    ...
    @Test
    public void check_fractions_OutOfBounds3() {
        long[][] lst;
	...
	@Test
	public void check_FaktorDecomposition() {
	...
	@Test
	public void check_ExponentDecomposition() {
	...
	@Test
	public void check_CommonDenominator() {
		...
		assertTrue(expected.factorSequence.equals(actual.factorSequence));
	}
